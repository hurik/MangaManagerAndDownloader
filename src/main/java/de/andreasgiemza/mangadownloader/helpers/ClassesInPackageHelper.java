 ...
 * @author BrainStone
 *
 *         http://stackoverflow.com/a/22462785/2246865
 *
 */
@SuppressWarnings("restriction")
public class ClassesInPackageHelper {
	 ...
	 *            the package name to search
	 * @param intface
	 *            the interface which the classes must implement
	 * @return a list of classes that exist within that package
	 * @throws ClassNotFoundException
	 *             if something went wrong
	 */
	public static ArrayList<Class<?>> getClassesForPackageWithInterface(
			String pckgname, Class<?> intface) throws ClassNotFoundException {
